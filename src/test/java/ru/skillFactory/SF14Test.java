...
public class SF14Test {
    ...
    public void sF14() {
        ...
        vars.put("win6770", waitForWindow(2000));
        {
            WebElement element = driver.findElement(By.tagName("body"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element, 0, 0).perform();
        }
        driver.switchTo().window(vars.get("win6770").toString());
        driver.findElement(By.cssSelector(".header__nav li:nth-child(4) > .internal-link")).click();
    }
}

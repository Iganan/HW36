...
public class SF11Test {
    ...
    public void sF11() {
        ...
        vars.put("win3081", waitForWindow(2000));
        {
            WebElement element = driver.findElement(By.tagName("body"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element, 0, 0).perform();
        }
        driver.switchTo().window(vars.get("win3081").toString());
        driver.findElement(By.cssSelector(".header__nav li:nth-child(1) > .internal-link")).click();
    }
}
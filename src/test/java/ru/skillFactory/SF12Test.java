...
public class SF12Test {
    ...
    public void sF12() {
        ...
        vars.put("win7851", waitForWindow(2000));
        {
            WebElement element = driver.findElement(By.tagName("body"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element, 0, 0).perform();
        }
        driver.switchTo().window(vars.get("win7851").toString());
        driver.findElement(By.cssSelector(".header__nav li:nth-child(2) > .internal-link")).click();
    }
}

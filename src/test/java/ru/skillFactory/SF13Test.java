...
public class SF13Test {
    ...
    public void sF13() {
        ...
        vars.put("win2320", waitForWindow(2000));
        {
            WebElement element = driver.findElement(By.tagName("body"));
            Actions builder = new Actions(driver);
            builder.moveToElement(element, 0, 0).perform();
        }
        driver.switchTo().window(vars.get("win2320").toString());
        driver.findElement(By.cssSelector(".header__nav li:nth-child(3) > .internal-link")).click();
    }
}